...
/* ==================== Profile ==================== */
function renderProfile(app,userId) { var sid=API.user?API.user.id:null,eid=userId||sid,isSelf=sid&&String(sid)===String(eid); app.innerHTML=(isGuest?renderGuestBanner():"")+'<div class="page"><div class="spinner"></div></div>'; loadProfile(eid,isSelf); }
