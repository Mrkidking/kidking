...
function navigate(view, data) {
    ...
    var guestBlocked = ["friends","families","family-detail","settings"];
...
/* ==================== Profile ==================== */
function renderProfile(app,userId) { var sid=API.user?API.user.id:null,eid=userId||sid,isSelf=sid&&String(sid)===String(eid); var isGuest=!API.token; app.innerHTML=(isGuest?renderGuestBanner():"")+'<div class="page"><div class="spinner"></div></div>'; loadProfile(eid,isSelf); }
